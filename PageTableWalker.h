...
namespace SST {
    namespace SambaComponent {
        ...
        public:
            ...
            PageTableWalker(ComponentId_t id, int page_size, int assoc, PageTableWalker *next_level,
                            int size);

            PageTableWalker(ComponentId_t id, int tlb_id, PageTableWalker *Next_level, int level,
                            SST::Params &params);
            ...
            void setShootDownEvents(int *sd, int *own_sd, std::list <Address_t> *x) {
                shootdown = sd;
                own_shootdown = own_sd;
                invalid_addrs = x;
            }

            void setPageMigration(int *page_mig, PageMigrationType *policy) {
                page_migration = page_mig;
                page_migration_policy = policy;
            }
            ...
            void setServiceBackSize(
                std::map<MemHierarchy::MemEventBase *, long long int, MemEventPtrCompare> *x) { service_back_size = x; }
